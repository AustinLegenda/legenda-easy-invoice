	...
	<table>
		...
		foreach ($line_items as $line_item) { ?>
			<tr class="">
				...
				<td class="rate center-text"><?php echo esc_html(easy_invoice_get_price($line_item->get_rate(), '', $ei_quote->get_id())); ?></td>
				<?php if (easy_invoice_show_hide_adjust()) { ?>
					<td class="adjust center-text"><?php echo esc_html($line_item->get_adjust()); ?>%</td>
				<?php } ?>
				<td class="total center-text"><?php echo esc_html(easy_invoice_get_price($line_item->get_amount(), '', $ei_quote->get_id())); ?></td>
			</tr>
		<?php } ?>
		</tbody>
	</table>
