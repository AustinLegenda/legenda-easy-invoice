<?php global $ei_quote;
?>
	<div class="title"><strong><?php echo esc_html(easy_invoice_get_text('to')); ?></strong></div>
<?php if ($ei_quote->get_client_name() !== '' && $ei_quote->get_client_url() !== '') { ?>
...
<?php } else if ($ei_quote->get_client_name() !== '') { ?>
	<div class="site-url"><p><?php echo esc_html($ei_quote->get_client_name()); ?></p></div>
<?php } ?>
...
<?php } ?>
	<div class="extra">
		<p><?php echo esc_html($ei_quote->get_client_email()) ?></p>
	</div>
