	...
	public function get_settings($current_section = '')
	{
		...
		$settings = array(
			...
			array(
				...
				'id' => 'easy_invoice_terms_conditions',
				'desc' => __('Terms and conditions that will be displayed on your invoice', 'easy-invoice'),
				'type' => 'textarea',
				'default' => 'Payment is due within 30 days from date of invoice'
			),
			array(
