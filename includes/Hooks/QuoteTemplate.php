...
class QuoteTemplate
{
	...
	{
		easy_invoice_load_template('parts.before-items-1', array('details_data' => easy_invoice_get_quote_details_data()));
	}

	public function before_items_2()
	{
		easy_invoice_load_template('parts.before-items-2');
	}
	...
	public function accept_decline_popup()
	{
		...
		easy_invoice_load_template('quote.decline-quote',
			array(
				'quote_id' => $quote_id,
				'error' => $error,
